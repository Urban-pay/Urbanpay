                    ...
                    <div className="modal-content">
                        <div className="modal-body flex justify-center items-center text-center">
                            <div>
                                ...
                                <div>
                                    <Link href="../home">
                                        <a className="text-white rounded-md decoration-none text-capitalize card-btn focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium text-sm w-full px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                            Go Home
                                        </a>
                                    </Link>
                                </div>
